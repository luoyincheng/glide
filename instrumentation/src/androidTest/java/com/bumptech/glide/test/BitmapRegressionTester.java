 ...
 * "regenerate" in /sdcard/DCIM/test_files. The apks containing this tester will need to have {@link android.Manifest.permission#WRITE_EXTERNAL_STORAGE}. Resources can be split by apk by adding {@link
 * SplitBySdk} to test methods or classes. If {@link SplitBySdk} is added to both a test class and a particular method, the values from the method will be used.
 *
