...
public class AnimatedGifEncoder {
   ...
   /**
    * Adds next GIF frame to the specified position. The frame is not written immediately, but is actually deferred until the next frame is received so that timing data can be inserted. Invoking
    * <code>finish()</code> flushes all frames. If <code>setSize</code> was invoked, the size is used for all subsequent frames. Otherwise, the actual size of the image is used for each frame.
    * <p>
