...
/**
 * Generates a new implementation of {@code com.bumptech.glide.request.RequestOptions} containing static versions of methods included in the base class and static and instance versions of all methods
 * annotated with {@link GlideOption} in classes annotated with {@link GlideExtension}.
 *
...
final class RequestOptionsGenerator {
   ...
   /**
    * This method is a bit of a hack, but it lets us tie the static version of a method with the instance version. In turn that lets us call the instance versions on the generated subclass, instead of
    * just delegating to the RequestOptions static methods. Using the instance methods on the generated subclass allows our static methods to properly call code that overrides an existing method in
    * RequestOptions.
    *
