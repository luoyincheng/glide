...
final class RequestManagerGenerator {
   ...
   /**
    * The {@code RequestOptions} subclass should always be our generated subclass type to avoid inadvertent errors where a different subclass is applied that accidentally wipes out some logic in
