...
/**
 * Generates a {@code com.bumptech.glide.RequestBuilder} subclass containing all methods from the base class, all methods from {@code com.bumptech.glide.request.RequestOptions} and all non-override
 * {@link GlideOption} annotated methods in {@link GlideExtension} annotated classes.
 *
...
final class RequestBuilderGenerator {
   ...
   /**
    * Generates methods with equivalent names and arguments to methods annotated with {@link GlideOption} in {@link com.bumptech.glide.annotation.GlideExtension}s that return our generated {@code
   ...
   /**
    * Generates an override of a particular method in {@code com.bumptech.glide.RequestBuilder} that returns {@code com.bumptech.glide.RequestBuilder} so that it returns our generated subclass
    * instead.
    */
