...
public final class SingleRequest<R> implements Request, SizeReadyCallback, ResourceCallback {
   ...
   @Recite(desc = "real request start 1 : target.getSize(this);")
   @Override
   public void begin() {
    ...
    */
   @Recite(desc = "real request start 2")
   @Override
   public void onSizeReady(int width, int height) {
      ...
      synchronized (requestLock) {
         ...
         PrettyLogger.glideFlow("before load...");
         loadStatus =
               engine.load(
                     glideContext,
                     model,
                     ...
                     this,
                     callbackExecutor);
         PrettyLogger.glideFlow("after load...");
