...
/**
 * A base {@link Target} for loading resources ({@link android.graphics.Bitmap}, {@link Drawable} etc) into {@link View}s that provides default implementations for most methods and can determine the
 * size of views using a {@link android.view.ViewTreeObserver.OnDrawListener}.
 *
