 ...
 * determine their state (ie do not call {@link Request#isCleared()} or {@link Request#isRunning()} etc). Instead use {@link RequestState} and the various methods available on this interface and
