...
public interface Resource<Z> {
    ...
    * it is often appropriate to return a new instance for each call. For example, {@link android.graphics.drawable.Drawable Drawable}s should only be used by a single {@link android.view.View View}
    * at a time so each call to this method for Resources that wrap {@link android.graphics.drawable.Drawable Drawable}s should always return a new {@link android.graphics.drawable.Drawable
    * Drawable}.
    */
   @NonNull
   Z get();
