...
public class Engine
   ...
   //jobs is only used to make sure there is only one same EngineJob one time, if a EngineJob has appeared in jobs, just add a callback to the appeared EngineJob
