...
public final class GlideExecutor implements ExecutorService {
   ...
   /**
    * Returns a new {@link Builder} with the {@link #DEFAULT_DISK_CACHE_EXECUTOR_THREADS} threads, {@link #DEFAULT_DISK_CACHE_EXECUTOR_NAME} name and {@link UncaughtThrowableStrategy#DEFAULT} uncaught
    * throwable strategy.
    *
   ...
   /**
    * Returns a new {@link Builder} with the default thread count returned from {@link #calculateBestThreadCount()}, the {@link #DEFAULT_SOURCE_EXECUTOR_NAME} thread name prefix, and the {@link
    * com.bumptech.glide.load.engine.executor.GlideExecutor.UncaughtThrowableStrategy#DEFAULT} uncaught throwable strategy.
    *
    ...
    * #SOURCE_UNLIMITED_EXECUTOR_NAME} thread name prefix, the {@link com.bumptech.glide.load.engine.executor.GlideExecutor.UncaughtThrowableStrategy#DEFAULT} uncaught throwable strategy, and the
    * {@link SynchronousQueue} since using default unbounded blocking queue, for example, {@link PriorityBlockingQueue} effectively won't create more than {@code corePoolSize} threads. See <a href=
    * "http://developer.android.com/reference/java/util/concurrent/ThreadPoolExecutor.html"> ThreadPoolExecutor documentation</a>.
    *
    * <p>Source executors allow network operations on their threads.
    */
