...
class EngineResource<Z> implements Resource<Z> {
    ...
    * consumers begin using the wrapped resource. It is always safer to call acquire more often than necessary. Generally external users should never call this method, the framework will take care of
    * this for you.
    */
