...
public interface BitmapPool {
    ...
    * than {@link #getDirty(int, int, android.graphics.Bitmap.Config)}. If the {@link android.graphics.Bitmap} is being obtained to be used in {@link android.graphics.BitmapFactory} or in any other
    * case where every pixel in the {@link android.graphics.Bitmap} will always be overwritten or cleared, {@link #getDirty(int, int, android.graphics.Bitmap.Config)} will be faster. When in doubt,
    * use this method to ensure correctness.
    *
    * <pre>
    ...
    * android.graphics.Bitmap.Config)} it should be used with caution and only when the caller is sure that they are going to erase the {@link android.graphics.Bitmap} entirely before writing new data
    * to it.
    *
    * @param width  The width in pixels of the desired {@link android.graphics.Bitmap}.
    * @param height The height in pixels of the desired {@link android.graphics.Bitmap}.
