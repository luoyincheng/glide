...
public final class PreFillType {
    ...
    * @param weight An integer indicating how to balance pre-filling this size and configuration of {@link android.graphics.Bitmap} against any other sizes/configurations that may be being
    *               pre-filled.
    */
