...
public final class Option<T> {
   ...
   /**
    * Updates the given {@link MessageDigest} used to construct a cache key with the given value using the {@link com.bumptech.glide.load.Option.CacheKeyUpdater} optionally provided in the
    * constructor.
    */
   ...
   public interface CacheKeyUpdater<T> {
       ...
       *
       * @param keyBytes The bytes of the {@link String} used as the key for this particular {@link Option}. Should be added to the {@code messageDigest} using {@link MessageDigest#update(byte[])} by
       *                 all implementations if the digest is updated with the given {@code value} parameter.
       * @param value    The value of of this particular option. Typically you should convert the value to a byte array using some stable mechanism and then call {@link MessageDigest#update(byte[])}
