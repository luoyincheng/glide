...
public class GifDrawable extends Drawable
   ...
   /**
    * True if the drawable is currently visible. Default to true because on certain platforms (at least 4.1.1), setVisible is not called on {@link android.graphics.drawable.Drawable Drawables} during
    ...
    * @param targetFrameWidth    The desired width of the frames displayed by this drawable (the width of the view or {@link com.bumptech.glide.request.target.Target} this drawable is being loaded
    *                            into).
    * @param targetFrameHeight   The desired height of the frames displayed by this drawable (the height of the view or {@link com.bumptech.glide.request.target.Target} this drawable is being loaded
    *                            into).
