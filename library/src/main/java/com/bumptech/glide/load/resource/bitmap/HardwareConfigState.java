...
public final class HardwareConfigState {
   /**
    * Force the state to wait until a call to allow hardware Bitmaps to be used when they'd otherwise be eligible to work around a framework issue pre Q that can cause a native crash when allocating a
    * hardware Bitmap in this specific circumstance. See b/126573603#comment12 for details.
    */
    ...
    * Processes have an FD limit of 1024 (at least on O). With sufficiently small {@link Bitmap}s and/or a sufficiently large {@link com.bumptech.glide.load.engine.cache.MemoryCache}, we can end up
    * with enough {@link Bitmap}s in memory that we blow through the FD limit, which causes graphics errors, Binder errors, and a variety of crashes.
    *
