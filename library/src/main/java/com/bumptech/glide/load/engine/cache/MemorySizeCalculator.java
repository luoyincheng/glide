...
public final class MemorySizeCalculator {
   ...
   public static final class Builder {
      ...
      /**
       * On Android O+, we use {@link android.graphics.Bitmap.Config#HARDWARE} for all reasonably sized images unless we're creating thumbnails for the first time. As a result, the Bitmap pool is much
       * less important on O than it was on previous versions.
       */
      ...
      /**
       * Sets the maximum percentage of the device's memory class for standard devices that can be taken up by Glide's {@link com.bumptech.glide.load.engine.cache.MemoryCache} and {@link
