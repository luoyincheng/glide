 ...
 * android.graphics.Bitmap Bitmaps}, which increases the hit rate of the pool and therefore the performance of applications. This class works around #301 by only allowing re-use of {@link
...
public class SizeConfigStrategy implements LruPoolStrategy {
   ...
   private static Bitmap.Config[] ARGB_8888_IN_CONFIGS;
