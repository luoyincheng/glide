 ...
 * or for resource types that we can't obtain an {@link java.io.InputStream} for using a standard {@link ContentResolver}, including some types of application icons and resources loaded from other
 * packages.
 */
