...
public abstract class BaseGlideUrlLoader<Model> implements ModelLoader<Model, InputStream> {
   ...
   /**
    * Returns a list of alternate urls for the given model, width, and height from which equivalent data can be obtained (usually the same image with the same aspect ratio, but in a larger size) as
    * the primary url.
    *
