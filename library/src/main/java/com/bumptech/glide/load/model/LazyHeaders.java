...
public final class LazyHeaders implements Headers {
    ...
    * be replaced by calls to either {@link #setHeader(String, LazyHeaderFactory)} or {@link #addHeader(String, String)}, even though {@link #addHeader(String, LazyHeaderFactory)} would usually append
    * an additional value.
    */
