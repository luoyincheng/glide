...
public class LoadPathCache {
   ...
   /**
    * Returns {@code} true if the given {@link LoadPath} is the signal object returned from {@link #get(Class, Class, Class)} that indicates that we've previously found that there are no available
    * paths to load the requested resources and {@code false} otherwise.
    */
